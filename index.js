...
bot.on("guildMemberAdd", async member => {
    ...
    .setTitle(`Entrada <:vailogo:769289824858538015>`)
...
bot.on("guildMemberRemove", async member => {
    ...
    .setTitle("Saída <:vailogo:769289826846375966>")
...
bot.on('ready', () => {
    ...
    let status = [
      {name: 'Use /help caso tenha dúvida.', type: 'WATCHING', url: 'https://www.twitch.tv/myblue1_'},
      {name: 'jogar.redevonix.com', type: 'WATCHING', url: 'https://www.twitch.tv/myblue1_'},
